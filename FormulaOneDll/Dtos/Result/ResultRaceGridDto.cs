...
namespace FormulaOneDll {
    public class ResultRaceGridDto {
        private int _raceId;
        ...
        public ResultRaceGridDto(int position, int driverNumber, string driverName, string teamName, string time, int raceId) {
        ...
        public ResultRaceGridDto(DataRow row) {
            this.Position = row.Field<int>("start_position");
            ...
            this.Time = row.Field<string>("qualifying_time");
